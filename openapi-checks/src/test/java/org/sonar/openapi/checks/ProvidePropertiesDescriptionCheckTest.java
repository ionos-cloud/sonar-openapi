...
public class ProvidePropertiesDescriptionCheckTest {
    @Test
  public void verify_in_v2() {
    OpenApiCheckVerifier.verify("src/test/resources/checks/v2/provide-properties-description.yaml", new ProvidePropertiesDescriptionCheck(), true);
  }
